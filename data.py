# -*- coding: utf-8 -*-
"""
Created on Mon May 11 21:45:15 2020
...
from audit import update_postal_code
from audit import zip_mapping
from audit import mapping


#osm_file = open("Chicago.xml", mode="r", encoding="utf-8")
        ...
        for child in element:
            ...
            if child.tag == 'tag':
                ...
                if child.attrib['k'][5:] == "postcode":
                        ...
                        way_tag['key'] = child.attrib['k'].split(':',1)[1]
                        way_tag['id'] = element.attrib['id']                
                        way_tag['value'] = update_postal_code(child.attrib['v'], zip_mapping)
                        tags.append(way_tag)      
...
#           REMOVED utf-8 hadnling ( shifted to codecs encoding )
